...
class TestSystemClient:
    ...
    def test_initialization(self, mock_control, mock_inference, mock_processing, 
                          mock_fetch, mock_qapp):
    ...
    def test_initialization_broadcast_mode(self, mock_socket, mock_control, 
                                         mock_inference, mock_processing, 
                                         mock_fetch, mock_qapp):
    ...
    @patch('clients.system_client.InferenceClient')
    @patch('clients.system_client.control')
    def test_initialization_gui_mode(self, mock_control, mock_inference, 
                                   mock_processing, mock_fetch, mock_qapp):
